...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 01, 2025 at 07:51 AM
...
INSERT INTO `ebooks` (`ebook_id`, `publisher_id`, `category_id`, `title`, `author`, `description`, `cover_image_url`, `file_link`, `price`, `status`, `published_date`, `created_at`) VALUES
(2, 11, 17, 'Fuck YOu', 'pakaya', 'dshjk,msfghnmbgbnbvnbvbvcbncvbvc', '../uploads/covers/6926ca9113a9d_20250916_1527_Modern Police Interface_simple_compose_01k58za6wpezhs2bfv3hbmsqg4.png', '../uploads/files/6926ca9113ab6_Library Management System.pdf', 350.00, 'Blocked', NULL, '2025-11-26 15:08:25');
...
INSERT INTO `users` (`user_id`, `role_name`, `email`, `password_hash`, `full_name`, `dob`, `bio`, `is_active`, `is_verified`, `created_at`) VALUES
(1, 'Admin', 'admin@readify.com', '$2y$10$zeabRlqPigrO2o0LmoZX5.MNA846pdX1zKe6Eo.aEj015z9NLXQZq', 'Admin', '1900-11-11', 'I serve as the CEO for Readify, overseeing critical administrative and operational functions to maintain high-level efficiency across all departments. My primary focus is on developing and implementing scalable processes that optimize resource management and enhance organizational structure. I am committed to supporting the executive team\'s strategic vision by ensuring a stable, well-managed operational foundation.', 1, 0, '2025-11-26 14:33:10'),
(9, 'Reader', 'luffy1@gmail.com', '$2y$10$lAZFICyibuFZY/3i4DYRw.yOhjnXcKHrD9dYVhQ426WnjIa2lRcn2', 'Luffy De Monkey', '2005-06-25', 'mmmmmm', 1, 0, '2025-11-26 14:37:45'),
(11, 'Publisher', 'jhon1@gmail.com', '$2y$10$FkAon8lQqoilhJzMK6lq8OfK8VviRrSB8ytpYWfftjOg.YzI.RAu2', 'Naruto', '2001-11-05', 'xcxzcxzcxzcxzczxcxz', 1, 0, '2025-11-26 15:06:09');
...
--
ALTER TABLE `ebooks`
  MODIFY `ebook_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
